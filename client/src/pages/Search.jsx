...
const Search = () => {
  ...
  if (loading) return (
    <div className="min-h-screen bg-white dark:bg-gray-900 flex items-center justify-center">
      <p className="text-gray-900 dark:text-white text-xl">Searching...</p>
    </div>
  );
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 p-4 md:p-6 transition-colors duration-300">
      ...
      {videos.length === 0 ? (
        <p className="text-gray-500 dark:text-gray-400 text-center mt-20 text-xl">
              ...
              <div className="flex flex-col justify-center">
                ...
                <div className="flex gap-2 flex-wrap mt-2">
                  {video.tags.map((tag, i) => (
                    <span key={i}
                      className="bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 px-2 py-1 rounded-full text-xs">
                      #{tag}
                    </span>
                  ))}
                </div>
