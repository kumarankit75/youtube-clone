...
const VideoPage = () => {
  ...
  if (!video) return (
    <div className="min-h-screen bg-white dark:bg-gray-900 flex items-center justify-center">
      <p className="text-gray-900 dark:text-white text-xl">Video not found.</p>
    </div>
  );
          ...
          {channel && (
            <div className="flex items-center justify-between bg-gray-100 dark:bg-gray-800 p-4 rounded-xl mb-4">
              <Link to={`/channel/${channel._id}`}
                ...
                <div className="w-10 h-10 rounded-full bg-red-600 overflow-hidden flex items-center justify-center font-bold text-lg text-white">
                  {channel.avatar
